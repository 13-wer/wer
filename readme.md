...
7. [Результат на тествой выборке](#результат-на-тестовой-выборке)
...
## Результат на тестовой выборке<a id="результат-на-тестовой выборке"></a>
Для проверки на тестовой выборке была отобрана модель, показавшая себя наилучшим образом при обучени и валидации на обучающей выборке.
...
Архив с моделью доступен по [ссылке](https://drive.google.com/uc?id=1jF93RUNs9e1-Dbp3KbW32-OMnpxtAxZG).
